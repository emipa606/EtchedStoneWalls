...
public class JobDriver_EtchWall : JobDriver
{
    ...
    private static int BaseWorkAmount => 600;
    private static DesignationDef DesDef => DesignationDefOf.EtchWall;
    private static StatDef SpeedStat => StatDefOf.SmoothingSpeed;
